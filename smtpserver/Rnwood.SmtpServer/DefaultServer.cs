...
/// <summary>
///     A default subclass of <see cref="SmtpServer" /> which provides a default behaviour which is suitable for many
///     simple
///     applications.
/// </summary>
...
public class DefaultServer : SmtpServer
{
    ...
    public DefaultServer(bool allowRemoteConnections, string domainName, int portNumber,
        X509Certificate implicitTlsCertificate, X509Certificate startTlsCertificate)
        : this(new DefaultServerBehaviour(allowRemoteConnections, domainName, portNumber, implicitTlsCertificate,
            startTlsCertificate))
    {
    }
    ...
    public event AsyncEventHandler<AuthenticationCredentialsValidationEventArgs>
        ...
        {
            add => Behaviour.AuthenticationCredentialsValidationRequiredEventHandler += value;
            remove => Behaviour.AuthenticationCredentialsValidationRequiredEventHandler -= value;
        }
    ...
    {
        add => Behaviour.MessageCompletedEventHandler += value;
        remove => Behaviour.MessageCompletedEventHandler -= value;
    }
    ...
    {
        add => Behaviour.MessageReceivedEventHandler += value;
        remove => Behaviour.MessageReceivedEventHandler -= value;
    }
    ...
    {
        add => Behaviour.SessionCompletedEventHandler += value;
        remove => Behaviour.SessionCompletedEventHandler -= value;
    }
    ...
    {
        add => Behaviour.SessionStartedEventHandler += value;
        remove => Behaviour.SessionStartedEventHandler -= value;
    }
}
