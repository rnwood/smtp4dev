    ...
    public static class CommandLineParser
    {
        public static MapOptions<CommandLineOptions> TryParseCommandLine(IEnumerable<string> args, bool isDesktopApp)
        {
            ...
            OptionSet options = new OptionSet
            {
                ...
                { "relaycheckcertificaterevocation", "Specifies whether the certificate revocation list should be checked when verifying the relay server's TLS certificate. Use -relaycheckcertificaterevocation+ to enable or -relaycheckcertificaterevocation- to disable. See: https://www.mimekit.net/docs/html/P_MailKit_MailService_CheckCertificateRevocation.htm", data => map.Add((data != null).ToString(), x => x.RelayOptions.CheckCertificateRevocation) },
                { "relaysslciphersuitespolicy=", "Specifies the TLS cipher suites to be allowed for the relay connection. Not supported on Windows. Separate with commas. See: https://learn.microsoft.com/en-us/dotnet/api/system.net.security.tlsciphersuite?view=net-9.0", data => map.Add(data, x => x.RelayOptions.SslCipherSuitesPolicyString) },
                ...
                { "pop3port=", "Specifies the port the POP3 server will listen on - allows standard email clients to retrieve messages", data => map.Add(data, x => x.ServerOptions.Pop3Port) },
