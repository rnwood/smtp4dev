    ...
    public static class CommandLineParser
    {
        public static MapOptions<CommandLineOptions> TryParseCommandLine(IEnumerable<string> args, bool isDesktopApp)
        {
            ...
            OptionSet options = new OptionSet
            {
                ...
                { "mailbox=", "Adds a mailbox. Format: \"Name=Recipients\" or JSON {\"name\":\"Name\",\"recipients\":\"*\",\"headerFilters\":[{\"header\":\"X-App\",\"pattern\":\"value\"}]}. This option can be repeated to add multiple mailboxes.", data =>
